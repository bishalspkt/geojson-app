                ...
                <div className="fixed left-3 right-3 top-16 sm:absolute sm:left-0 sm:right-auto sm:top-full sm:mt-2.5 sm:w-64 rounded-2xl bg-white/70 backdrop-blur-2xl border border-white/30 shadow-2xl shadow-black/10 p-4 flex flex-col gap-4 z-50">
                    ...
                    <div className="border-t border-black/8 pt-3">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            >
                                <Map className={`h-4 w-4 ${projection === "mercator" ? "text-primary" : "text-gray-400"}`} />
                                <span className={`text-xs font-bold ${projection === "mercator" ? "text-primary" : "text-gray-600"}`}>Flat</span>
                            </button>
                            <button
                            ...
                            >
                                <Globe className={`h-4 w-4 ${projection === "globe" ? "text-primary" : "text-gray-400"}`} />
                                <span className={`text-xs font-bold ${projection === "globe" ? "text-primary" : "text-gray-600"}`}>Globe</span>
                            </button>
                        </div>
                    </div>
                </div>
